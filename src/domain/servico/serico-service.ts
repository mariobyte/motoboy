...
export class ServicoService {
    ...
    registrarServico(servico: Servico, idMotoboy: number, checkin: StatusMovimentacao) { // 1 - Entrada 2 - Saida
        ...
        let url = `http://cortex-sc-dsv.dyndns.org/scriptcase/app/MotoBoy/wscheckin/wscheckin.php?IdUsuario=${idMotoboy}&idOs=${servico.id_os}&iditem=${servico.id_item}&checkin=${checkin}&data=${data}&latitude=${servico.latitude}&longitude=${servico.longitude}&obs=${servico.obs}`;
